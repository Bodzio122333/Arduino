char *PIDName[]   ={"Stała  P", "Stała  I", "Stała  D", "Windowset  ", "Używane w gotowaniu", "Kalibracja"};
char *stageName[] ={"Zacieranie w   ", "Phytase   ", "Glucanase ", "Protease  ", "bAmylase  ", "aAmylase1 ", "aAmylase2 ", "Mash Out  ", "Gotowanie      "};
char *unitName[]  ={"Wybierz stopnie  ", "Czujnik   ", "Wybierz gotowanie    ", "Wybierz gotowanie    ", "Cykl pompy   ", "Czas resetu pompy ", "Pump on Boil ", "Stop pompy o  "};
